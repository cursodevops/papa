...
public class ComisionesIP {

	public static String VENDEDOR="Vendedor";
	public static String ENCARGADO="Encargado";
	public static String HOME="home";
	
	public static int IMPORTE_VENTAS_MES_TRAMO_1=1250;
	public static int IMPORTE_VENTAS_MES_TRAMO_2=1750;
	public static int SALARIO_0=800;
	public static int SALARIO=1600;
	public static int SALARIO1=2100;
